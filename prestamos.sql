...
/*!50106 DROP EVENT IF EXISTS `evento_prestamos_verano` */;;
DELIMITER ;;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `evento_prestamos_verano` ON SCHEDULE EVERY 1 YEAR STARTS '2023-06-21 00:00:01' ENDS '2027-01-01 00:00:01' ON COMPLETION NOT PRESERVE ENABLE DO insert into prestamos (periodo,fechaOfer,plazo,interes,cantidad,uuid)
select(
(2,"2023-06-21",12,3.9,4000,"03f832c9-fa5d-11ed-be56-0242ac120002"),
(2,"2023-06-21",12,3.9,4000,"0245c353-fa61-11ed-be56-0242ac120002"),
(2,"2023-06-21",12,3.9,4000,"1994c60d-fa62-11ed-be56-0242ac120002"),
(2,"2023-06-21",12,3.9,4000,"1a7d8645-fa5b-11ed-be56-0242ac120002"),
(2,"2023-06-21",12,3.9,4000,"0893ea34-fa5c-11ed-be56-0242ac120002"),
(2,"2023-06-21",12,3.9,4000,"277b9255-fa5f-11ed-be56-0242ac120002")) */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
-- Dump completed on 2023-05-26 15:14:29
